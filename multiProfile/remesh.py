...
os.system("./Allclean.sh; ~/Desktop/FreeCAD-0.21.2-Linux-x86_64.AppImage -c multiProfile.py; python3 ffdRead.py; python3 prePro.py")
...
for ii in range(10):
	...
	os.system("surfaceMeshExtract mep.stl -patches '(flap main)'")
